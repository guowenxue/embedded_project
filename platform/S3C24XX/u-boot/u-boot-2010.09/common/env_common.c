...
/* This part add by guowenxue */
    ...
    "cpu=" CONFIG_CPU "\0"
#endif              
#if defined(CONFIG_BURNBL)     /* Burn bootloader image */
    "bbl=" CONFIG_BURNBL "\0"
#endif              
#if defined(CONFIG_BURNKERNEL) /* Burn Linux kernel image  */
    "bkr=" CONFIG_BURNKERNEL "\0"
#endif              
#if defined(CONFIG_BURN_RAMDISK) /* Burn Root filesystems image */
    "bfs=" CONFIG_BURN_RAMDISK "\0" 
#endif          
#if defined(CONFIG_BOOT_RAMDISK) /* Use ramdisk file system boot */
