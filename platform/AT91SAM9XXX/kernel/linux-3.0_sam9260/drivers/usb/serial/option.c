...
static const struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(SIMCOM_VENDOR_ID, SIMCOM_PRODUCT_SIM5215) }, /* Add by guowenxue, 2011.08.04 */
	{ USB_DEVICE(SIMCOM_VENDOR_ID, SIMCOM_PRODUCT_SIM5216) }, /* Add by guowenxue, 2011.08.04 */
