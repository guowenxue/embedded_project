...
void __init at91_add_device_eth(struct at91_eth_data *data)
{
    ...
    /*Mini-STAC board, data->is_rmii==1, so PA28,PA29,PA30 not conflict, comment by guowenxue*/
	if (!data->is_rmii) { 
...
{
//	at91_set_A_periph(AT91_PIN_PB10, 1);		/* TXD3 */ /*Comment by guowenxue,conflict with SAM card*/
//	at91_set_A_periph(AT91_PIN_PB11, 0);		/* RXD3 */ /*Comment by guowenxue,conflict with SAM card*/
...
//	at91_set_B_periph(AT91_PIN_PA30, 0);		/* RXD4 Comment by guowenxue,conflict with SAM card*/
}
