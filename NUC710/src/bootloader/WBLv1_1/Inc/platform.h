...
#define GPIO_CFG2	VPint(APBBASE+0x3020)
#define GPIO_CFG5	VPint(APBBASE+0x3050)
...
#define BL_CACHE_DEFAULT 0x1		//Set cache on as default by changed from 0x0 to 0x1 by guowenxue, 2009.08.07
