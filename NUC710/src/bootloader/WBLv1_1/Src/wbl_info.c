...
#define WBL_VERSION_STRING	"1.2"
#define REVISION " $Revision: 2 $" 
#define WBL_BANNER "L200 Boot Loader [ Version " WBL_VERSION_STRING REVISION " ] Rebuilt on " __DATE__ "\n"
...
void WBL_info()
{
    ...
    uprintf("Copyright (c) GHL Systems Berhad 2011. All rights reserved.\n");
