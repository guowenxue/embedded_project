...
/* S29GL064N90TFI04, add by guowenxue */
INT ReadPID_S29GL064N(UINT32 address, UCHAR *PID0, UCHAR *PID1);
INT BlockSize_S29GL064N(UINT32 address);

/* SST39VF6401 */
INT ReadPID_SST39VF6401(UINT32 address, UCHAR *pid0, UCHAR *pid1);
INT ReadPID_SST39VF6401B(UINT32 address, UCHAR *pid0, UCHAR *pid1);
INT BlockErase_SST39VF6401(UINT32 address,UINT32 size);
INT BlockErase_SST39VF6401B(UINT32 address,UINT32 size);
INT BlockWrite_SST39VF6401(UINT32 address, UCHAR * data, UINT32 size);
INT BlockWrite_SST39VF6401B(UINT32 address, UCHAR * data, UINT32 size);
/* Intel E28F640 */
...
flash_t flash[]={
/*S29GL064N90TFI04, add by guowenxue*/
{0x01,0x7E,"S29GL064N", BlockSize_E28F640,BlockErase_AM29LV800BB,BlockWrite_AM29LV800BB,ReadPID_S29GL064N,BlockLock_AM29LV800BB},
...
{0xBF,0x6D,"SST39VF6401B",BlockSize_E28F640,BlockErase_SST39VF6401B,BlockWrite_SST39VF6401B,ReadPID_SST39VF6401B,BlockLock_AM29LV800BB},
...
/*address is FLASH_BASE on W90P710, which is 0x7F000000, add note by guowenxue*/
...
INT BlockErase_SST39VF6401B(UINT32 address,UINT32 size)
{
	...
	address|=0x80000000;
	addr1=(address&0xFFF00000)+(0x555<<1);
	addr2=(address&0xFFF00000)+(0x2AA<<1);
