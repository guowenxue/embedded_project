...
#define GPRS_CHK_MODEL              _IO (GHL_PLATDRV_MAGIC, 0x3E)  /*L200 ARM9 new version, Mini STAC */
...
#define SAM_PRESENT_DETECT          _IO   (GHL_PLATDRV_MAGIC, 0x78) /*L200 new board support it */
